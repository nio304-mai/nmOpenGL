...
solution "demo3d-mc12101"
   ...
   project "mc12101-host"
		kind "ConsoleApp"
		language "C++"
		files { ROOT .. "include/*.h","../src_host/*.cpp","../src_host/*.c", ROOT .. "nmglvs_mc12101-gcc/src_host/*.cpp"}
		libdirs { "$(MC12101)/lib","$(VSHELL)/lib","$(NMPP)/lib","$(HAL)/lib"}
		includedirs { "$(MC12101)/include","$(HAL)/include","$(VSHELL)/include","$(NMPP)/include",ROOT .. "include", "../include"}
	...
	project "mc12101-nmc4-0"
      kind "Makefile"
      files { ROOT .. "include/*.h","../src_target0/*.*", ROOT .. "nmglvs_mc12101-gcc/src_nmc0/*.*", "mc12101brd-nmc0.cfg", "Makefile0" }
	  includedirs { "$(MC12101)/include","$(HAL)/include","$(NMPP)/include",ROOT .. "include","../include"}
	  defines { "__GNUC__"}
	...
	project "mc12101-nmc4-1"
      kind "Makefile"
      files { ROOT .. "include/*.h","../src_target1/*.*", ROOT .. "nmglvs_mc12101-gcc/src_nmc1/*.*","mc12101brd-nmc1.cfg", "Makefile1" }
	  includedirs { "$(MC12101)/include","$(HAL)/include","$(NMPP)/include",ROOT .. "include"}
	  defines { "__GNUC__"}
